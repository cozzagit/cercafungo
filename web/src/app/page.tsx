      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/scanner"
              className="text-sm bg-forest-500 hover:bg-forest-600 text-white px-4 py-2 rounded-lg font-semibold transition-colors flex items-center gap-1.5"
            >
  ...
  return (
    <section id="download" className="py-20 md:py-28 bg-gradient-to-br from-forest-700 via-forest-800 to-forest-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <Link
          href="/scanner"
          className="inline-flex items-center gap-3 bg-forest-500 hover:bg-forest-600 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all shadow-lg shadow-forest-500/30 hover:shadow-xl hover:shadow-forest-500/40 mb-4 animate-pulse-glow"
        >
        ...
        <p className="text-forest-300 text-sm mb-6">Apri la fotocamera e identifica i funghi dal browser</p>
